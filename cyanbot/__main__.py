...
def new_instance(tree: CommandTree, cmd: str, arg: str) -> None:
    pass


@ctree.add_command("run")
def run_instance(tree: CommandTree, cmd: str, arg: str) -> None:
    pass


@ctree.add_command("plugin")
def manage_plugins(tree: CommandTree, cmd: str, arg: str) -> None:
    pass
